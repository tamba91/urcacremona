window.onload = function () {
    fetchWeatherData('http://api.openweathermap.org/data/2.5/weather?q=Cremona&units=metric&lang=it&appid=b734a115782cc2c4b428f09c5d0a6d63', manageResults);
}
...
function manageResults(wData) {
    ...
    iconDiv.innerHTML = `<img src='http://openweathermap.org/img/wn/${wData.weather[0].icon}@2x.png' class='u-max-full-width'>`
